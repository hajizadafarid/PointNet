...
[PointNet](https://arxiv.org/abs/1612.00593) is a fundamental yet powerful neural network processing point cloud data. We implemented PointNet for different tasks including _classification_, _auto-encoding_, and _segmentation_ by implementing them. The original paper is the [PointNet](https://arxiv.org/abs/1612.00593) paper together with [our brief summary](https://visual-ai-kaist.notion.site/Tutorial-1-PointNet-12e12629c85e40779f18633f1e7144b7). Also, this is how to implement codes using Pytorch ([Pytorch Tutorial link](https://pytorch.org/tutorials/beginner/pytorch_with_examples.html)).
